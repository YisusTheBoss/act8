...
class Get_connection:
    ...
    def Get_conn(self):
        ...
        #if not mt5.initialize(login=68254071, server="XMGlobal-MT5 2",password="testcontra"):
...
file1 = open("C:/Users/MauROG/Documents/Mau/Master/Tetra 4/actividad 8/prediction.txt","w")
...
ob_pred=Get_train_predict(coin_pairs, True, "H4", 5012361735,"MetaQuotes-Demo","ejx0yogp", current_time.year, current_time.month, current_time.day, mt5.TIMEFRAME_H4, 20000, 0.8, 10, 5, False, 'cumul')
